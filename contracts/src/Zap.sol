...
contract Zap is Ownable2Step, ReentrancyGuard {
    ...
    constructor(address initialAsset, address initialVault) {
        if (initialAsset == address(0) || initialVault == address(0)) revert ZeroAddress();
        asset = initialAsset;
        vault = initialVault;
