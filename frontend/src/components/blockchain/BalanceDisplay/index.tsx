...
export const BalanceDisplay: FC<BalanceDisplayProps> = ({account, token, description, displaySymbol}) => {
  ...
  return (
    <CaptionedNumber caption={description} number={balance} symbol={symbol}/>
  );
};
