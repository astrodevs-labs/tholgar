const warStakerABI = [
  {
    inputs: [{ internalType: 'address', name: '_warToken', type: 'address' }],
    stateMutability: 'nonpayable',
    type: 'constructor'
  },
  { inputs: [], name: 'AlreadyListedDepositor', type: 'error' },
  { inputs: [], name: 'CallerNotAllowed', type: 'error' },
  { inputs: [], name: 'CallerNotPendingOwner', type: 'error' },
  { inputs: [], name: 'CannotBeOwner', type: 'error' },
  { inputs: [], name: 'MismatchingFarmer', type: 'error' },
  { inputs: [], name: 'NotListedDepositor', type: 'error' },
  { inputs: [], name: 'NumberExceed128Bits', type: 'error' },
    ...
    outputs: [
      {
        ...
        internalType: 'struct WarStaker.UserClaimedRewards[]',
        name: '',
        type: 'tuple[]'
      }
    ],
  ...
  },
  {
    ...
    name: 'getUserRewardState',
    outputs: [
      {
        components: [
          { internalType: 'uint256', name: 'lastRewardPerToken', type: 'uint256' },
          { internalType: 'uint256', name: 'accruedRewards', type: 'uint256' }
        ],
        internalType: 'struct WarStaker.UserRewardState',
        name: '',
        type: 'tuple'
      }
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint128', name: 'distributionEndTimestamp', type: 'uint128' },
      { internalType: 'uint256', name: 'ratePerSecond', type: 'uint256' },
      { internalType: 'uint256', name: 'currentRewardAmount', type: 'uint256' },
      { internalType: 'uint256', name: 'queuedRewardAmount', type: 'uint256' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
