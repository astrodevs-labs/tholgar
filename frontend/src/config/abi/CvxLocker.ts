const cvxLockerAbi = [
  { inputs: [], stateMutability: 'nonpayable', type: 'constructor' },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'address', name: '_kicked', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: '_user', type: 'address' },
      { indexed: true, internalType: 'address', name: '_rewardsToken', type: 'address' },
      { indexed: false, internalType: 'uint256', name: '_reward', type: 'uint256' }
    ],
    name: 'RewardPaid',
    type: 'event'
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: '_user', type: 'address' },
      { indexed: true, internalType: 'uint256', name: '_epoch', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_paidAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_lockedAmount', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: '_boostedAmount', type: 'uint256' }
    ],
    name: 'Staked',
    type: 'event'
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint208', name: 'rewardPerTokenStored', type: 'uint208' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
  ...
  {
    inputs: [{ internalType: 'address', name: '_withdrawTo', type: 'address' }],
